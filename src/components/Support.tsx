...
const Support = () => {
  ...
  const paymentMethods = [
    { name: "Orange Money", code: "*144*1#", color: "bg-orange-500" },
    { name: "Wave", code: "#144#", color: "bg-blue-500" },
    { name: "MTN MoMo", code: "*155#", color: "bg-yellow-500" },
    { name: "Moov Money", code: "*555#", color: "bg-green-500" }
  ];
